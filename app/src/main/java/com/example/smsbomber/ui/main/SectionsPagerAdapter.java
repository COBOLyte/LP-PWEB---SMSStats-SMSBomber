...
import com.example.smsbomber.fragments.SmsBomber;
...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        Fragment fragment = new SmsStats();
        if (position == 1) fragment = new SmsCheck();
        else if (position == 2) fragment = new SmsBomber();
        return fragment;
    }
